...
const MetronomeScreen: React.FC = () => {
  ...
  return (
    <div className="bg-[#0b0f17] font-display antialiased text-white min-h-screen flex flex-col relative w-full overflow-hidden pb-24">
      ...
      <main className="flex-1 w-full px-6 max-w-screen-2xl mx-auto relative z-10 overflow-y-auto scrollbar-hide">
        <div className="flex flex-col landscape:flex-row md:flex-row items-center justify-around landscape:justify-center md:justify-center gap-8 landscape:gap-12 md:gap-16 w-full min-h-full py-2">
          ...
          <div className="relative flex items-center justify-center shrink-0">
            <svg className="rotate-[-90deg] w-[70vw] h-[70vw] max-w-[280px] max-h-[280px] landscape:w-[35vh] landscape:h-[35vh] md:w-[340px] md:h-[340px] lg:w-[420px] lg:h-[420px] transition-all duration-300">
            ...
            <div className="absolute inset-0 m-auto rounded-full bg-[#111622] border-[4px] border-[#1a2333] shadow-[0_0_60px_rgba(0,0,0,0.7)] flex flex-col items-center justify-center z-10 w-[62vw] h-[62vw] max-w-[250px] max-h-[250px] landscape:w-[30vh] landscape:h-[30vh] md:w-[300px] md:h-[300px] lg:w-[370px] lg:h-[370px]">
